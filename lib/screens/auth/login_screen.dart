            ...
            children: [
              ...
              Align(
                ...
                child: TextButton(
                  ...
                  child: const Text(
                    'Forgot password?',
                    style: TextStyle(color: Color(0xFF3DDB6F), fontSize: 13),
                  ),
                ),
              ),
              ...
              Row(
                children: [
                  const Expanded(child: Divider(color: Color(0xFF2A3A2F))),
                  const Padding(
              ...
              Center(
                child: Row(
                  ...
                  children: [
                    const Text(
                      'New to Pocketra? ',
                      style: TextStyle(color: Color(0xFF6B7C75), fontSize: 14),
                    ),
                    GestureDetector(
